...
public class AdminControllerLayerTest {
    ...
    public void testSaveAdmin() throws Exception {
        ...
        Admin admin = new Admin(1, 123, "Max", "Mann", "mann@gmx.de", "Olgastr. 2");
    ...
    public void testFecthAdminInDB() throws Exception {
        ...
        List<Admin> adminList = Arrays.asList(
                new Admin(1,3862349,"John", "Smith", "smith@thu.de", "Neue Str. 23"),
                new Admin(1,2131099,"Ann", "Doe", "doe@thu.de", "Neue Str. 8723"),
                new Admin(1,27683421,"Jane", "Winter", "winter@thu.de", "Neue Str. 90")
        );
